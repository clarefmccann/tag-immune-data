...
physio.log_files.cardiac = {'PULS.log'};
physio.log_files.respiration = {'RESP.log'};
physio.log_files.scan_timing = {'Info.log'};
physio.log_files.relative_start_acquisition = 0;
physio.log_files.align_scan = 'last';
physio.scan_timing.sqpar.Nslices = 72;
physio.scan_timing.sqpar.TR = 2;
physio.scan_timing.sqpar.Ndummies = 0;
physio.scan_timing.sqpar.Nscans = 242;
physio.scan_timing.sqpar.onset_slice = [1:physio.scan_timing.sqpar.Nslices];
